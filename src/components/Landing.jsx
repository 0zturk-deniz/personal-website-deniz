  ...
  return (
    <>
      <section className="dark:bg-[linear-gradient(to_right,_#171043_0%,_#171043_70%,_#211F0B_70%,_#211F0B_100%)] bg-[linear-gradient(to_right,_#4731D3_0%,_#4731D3_70%,_#CBF281_70%,_#CBF281_100%)] h-max font-inter">
        <Container>
          <div className="flex flex-col-reverse md:flex-row items-center md:items-end gap-10 md:gap-16 py-16 md:pb-36">
            <div className="space-y-6 text-center md:text-left">
              <h1 className="font-inter text-4xl sm:text-5xl font-semibold text-[#CBF281]">
                {content.title}
              </h1>
